...
https://developer.android.com/reference
 ...
 # Testing
 - As this is a test-driven developent, we initially used TravisCI to build and test the app. However, we alternatd to GitHub's built-in CI by implementing GitHub Action to fix the error we enountered. Codecov was another testing tool used to measure the percentage of code that was tested and which parts that were not tested. The following are badges that show the testing progress of our project.
 - 
