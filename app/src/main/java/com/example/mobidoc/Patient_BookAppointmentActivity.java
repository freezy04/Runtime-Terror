...
public class Patient_BookAppointmentActivity extends AppCompatActivity implements View.OnClickListener{
                    ...
                    mDataBaseRef.child(getIntent().getStringExtra("DoctorUserId")).child(date).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if(i>30)
                            {
                                ...
                                //I am yet to implement this class
    ...
    private void setDefaultColor(int i) {
        ...
        switch (i) {
            case 1: c1.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c1.setEnabled(true);
                break;
            case 2:
                c2.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c2.setEnabled(true);
                break;
            case 3:
                c3.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c3.setEnabled(true);
                break;
            case 4:
                c4.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c4.setEnabled(true);
                break;
            case 5:
                c5.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c5.setEnabled(true);
                break;
            case 6:
                c6.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c6.setEnabled(true);
                break;
            case 7:
                c7.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c7.setEnabled(true);
                break;
            case 8:
                c8.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c8.setEnabled(true);
                break;
            case 9:
                c9.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c9.setEnabled(true);
                break;
            case 10:
                c10.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c10.setEnabled(true);
                break;
            case 11:
                c11.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c11.setEnabled(true);
                break;
            case 12:
                c12.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c12.setEnabled(true);
                break;
            case 13:
                c13.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c13.setEnabled(true);
                break;
            case 14:
                c14.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c14.setEnabled(true);
                break;
            case 15:
                c15.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c15.setEnabled(true);
                break;
            case 16:
                c16.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c16.setEnabled(true);
                break;
            case 17:
                c17.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c17.setEnabled(true);
                break;
            case 18:
                c18.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c18.setEnabled(true);
                break;
            case 19:
                c19.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c19.setEnabled(true);
                break;
            case 20:
                c20.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c20.setEnabled(true);
                break;
            case 21:
                c21.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c21.setEnabled(true);
                break;
            case 22:
                c22.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c22.setEnabled(true);
                break;
            case 23:
                c23.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c23.setEnabled(true);
                break;
            case 24:
                c24.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c24.setEnabled(true);
                break;
            case 25:
                c25.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c25.setEnabled(true);
                break;
            case 26:
                c26.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c26.setEnabled(true);
                break;
            case 27:
                c27.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c27.setEnabled(true);
                break;
            case 28:
                c28.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c28.setEnabled(true);
                break;
            case 29:
                c29.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c29.setEnabled(true);
                break;
            case 30:
                c30.setCardBackgroundColor(getResources().getColor(R.color.light_blue));
                c30.setEnabled(true);
                break;
            default:
                break;
